    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button0.setOnClickListener {
            if (board[0] != "")
                ...
                button0.setTextColor(
                    ResourcesCompat.getColor(
                        resources,
                        R.color.colorPlayOptionX,
                        null
                    )
                )
                button0.text = "X"
